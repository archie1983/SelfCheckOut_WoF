...
public class PPHVaultAndPayTransactionViewModel extends ViewModel
{
  private PPHVaultAndPayTransactionModel _vaultAndPayTransactionModel;
  ...
  public PPHVaultAndPayTransactionViewModel()
  {
    _vaultAndPayTransactionModel = new PPHVaultAndPayTransactionModel();
  }
  ...
  void beginPayment()
  {
    _vaultAndPayTransactionModel.createTransaction(
        PPHVaultAndPayTransactionViewModel.this._invoice,
