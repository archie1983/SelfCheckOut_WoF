package com.example.selfcheckout_wof.PPH.activities.transactionSelection;
...
import com.example.selfcheckout_wof.PPH.activities.vaultAndPayTransaction.PPHVaultAndPayTransaction;
import com.example.selfcheckout_wof.PPH.activities.vaultTransaction.PPHVaultTransaction;
import com.example.selfcheckout_wof.PPH.ui.ChargeActivity;
import com.example.selfcheckout_wof.R;

public class PPHTransactionSelection extends AppCompatActivity
{
  ...
  protected void onCreate(Bundle savedInstanceState)
  {
    ...
    setContentView(R.layout.pph_activity_transaction_selection);
...
//      TextView textView = parent.findViewById(R.id.transaction_selection_text_view);
      LinearLayout linearLayout = (LinearLayout) LayoutInflater.from(parent.getContext()).inflate(R.layout.pph_content_transaction_selection, parent, false);
    ...
    public void onBindViewHolder(@NonNull TransactionSelectionViewHolder holder, int position)
    {
      ...
      holder._linearLayout.setOnClickListener(new View.OnClickListener()
      {
        ...
        Intent getIntent(@NonNull String transactionType, @NonNull Context context)
        {
          ...
          {
            return new Intent(context, PPHVaultTransaction.class);
          }
          if (transactionType.equalsIgnoreCase(context.getString(R.string.transaction_selection_vault_and_pay)))
          {
            return new Intent(context, PPHVaultAndPayTransaction.class);
          }
          return new Intent(context, ChargeActivity.class);
        }
