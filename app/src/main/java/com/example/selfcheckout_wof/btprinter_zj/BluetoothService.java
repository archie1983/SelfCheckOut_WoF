...
public class BluetoothService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BTPrinterConstants.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(BTPrinterConstants.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(BTPrinterConstants.DEVICE_NAME, device.getName());
        msg.setData(bundle);
            ...
            while (true) {
                try {
                    ...
                    if(bytes>0)
                    {
                        ...
                        mHandler.obtainMessage(BTPrinterConstants.MESSAGE_READ, bytes, -1, buffer)
                                .sendToTarget();
                    }
                    else
                    {
        ...
        public void write(byte[] buffer) {
            try {
               ...
               /* if (buffer.length > 3000) //
                ...
                mHandler.obtainMessage(BTPrinterConstants.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
